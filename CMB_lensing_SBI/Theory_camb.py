...
class theory(object):
    ...
    def __init__(self, sigma_8 = None, cosmo=None,lmax=4000,nz=140,fast=False,feedback=1,halofit_version='mead',cambini=None, chistar = None):
