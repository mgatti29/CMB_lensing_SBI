...
noise_uk = args.white_noise_level
...
mg = solenspipe.LensingSandbox(fwhm_arcmin,noise_uk,dec_min=None,dec_max=None,res=None,
                               ...
                               add_noise_map = False,noise_map_path = None,
...
def load_mock_data():
    data_mock = enmap.read_map(f"{args.sbi_maps}")
...
data_map = load_mock_data()  #take signal sim, convolve with beam and add noise map !!!!
